...
class NotificationCenterPageView(PageView):
    def __init__(self, parent):
        ...
        resized_image = original_image2.resize(desired_size2)
        ...
        resized_image = original_image3.resize(desired_size3)

        # 覆盖原始图片
        resized_image.save(original_image_path2)
        resized_image.save(original_image_path3)

    def render(self):
        from pages.main_page.main_page_controller import MainPageController
        button_1 = CanvasButton(self.canvas, 420, 120, self.image_path / "image_3.png",lambda: MainPageController.switch_page(self,"my_baggage"))
        button_2 = CanvasButton(self.canvas, 420, 220, self.image_path / "image_3.png",lambda: MainPageController.switch_page(self,"my_baggage"))
